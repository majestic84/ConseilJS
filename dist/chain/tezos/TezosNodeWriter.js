...
(function (TezosNodeWriter) {
    ...
    function sendTransactionOperation(server, keyStore, to, amount, fee, derivationPath = '', counter) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!counter) {
                counter = (yield TezosNodeReader_1.TezosNodeReader.getCounterForAccount(server, keyStore.publicKeyHash)) + 1;
            }
            const transaction = {
                destination: to,
